...
docsCanvasUI <- function(id) {
  ...
  tags$div(style = "max-width:900px;margin:0 auto;padding:18px 10px;",
    ...
    .doc_section("doc-copilot", "6. The AI Co-Pilot",
      .doc_p("Open the ", .doc_b("Co-Pilot"), " from the top bar. You can ask about the current screen,",
...
docsToolsUI <- function(id) {
  ...
  tags$div(
    ...
    jump("doc-copilot",   "6. AI Co-Pilot"),
